...
def run_prepare_data(original_dir, output_dir, valid_task_dirs):
    ...
    subprocess.run([
        "python", "/workspace1/gonzalo.fuentes/CVR_CENIA/experiments/ClipVIT/prepare_data_generalization.py",  # Cambié el nombre del script a prepare_data_generalization.py
...
def run_training(data_dir, output_dir, cuda_devices, batch_size, lr, epochs):
    ...
    command = [
        "python", "/workspace1/gonzalo.fuentes/CVR_CENIA/experiments/ClipVIT/ClipVIT_training.py",
        "--data_dir", data_dir,
        "--output_dir", output_dir,
...
if __name__ == "__main__":
    ...
    BASE_OUTPUT_ROOT = "/workspace1/gonzalo.fuentes/CVR_CENIA/experiments/ClipVIT/images_processed"
